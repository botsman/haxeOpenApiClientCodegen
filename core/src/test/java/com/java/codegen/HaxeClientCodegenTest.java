 ...
 * 1) Set a break point in HaxeClientCodegen.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class HaxeClientCodegenTest {
  ...
  //             .setGeneratorName("HaxeClientCodegen") // use this codegen library
  ...
  //             .setOutputDir("out/HaxeClientCodegen"); // output directory
