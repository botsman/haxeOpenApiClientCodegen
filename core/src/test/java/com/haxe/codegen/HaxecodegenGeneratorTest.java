 ...
 * 1) Set a break point in HaxecodegenGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
// public class HaxecodegenGeneratorTest {
...
//               .setGeneratorName("HaxeCodegen") // use this codegen library
...
//               .setOutputDir("out/HaxeCodegen"); // output directory
